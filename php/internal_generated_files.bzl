...
WKT_GENERATED_FILES = [
    ...
    "src/GPBMetadata/Google/Protobuf/JsonOptions.php",
    "src/GPBMetadata/Google/Protobuf/JsonEnumvalueOptions.php",
...
DESCRIPTOR_GENERATED_FILES = [
    ...
    "src/Google/Protobuf/Internal/JsonEnumvalueOptions.php",
    "src/Google/Protobuf/Internal/JsonOptions.php",
